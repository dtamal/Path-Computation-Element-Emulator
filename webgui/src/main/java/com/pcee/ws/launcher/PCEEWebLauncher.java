...
public class PCEEWebLauncher {
  ...
  private static Logger logger = PCEELoggerFactory
   ...
   * @throws IOException
   */
  private static ServletContextHandler getWsHandlers(boolean isServerRole, ResourceFactory resourceFactory)
...
//    }
      ...
      staticContentHolder.setInitParameter("dirAllowed", "true"); // Allow directory listing (optional)
  ...
  public static void main(String[] args) {
    try {
      ...
      PCEELoggerFactory.setOperation((arg) -> {
