...
/**
 * ThreadPool implementation to support multiple path computations, also includes an update server
 * to support topology updates
 *
...
public class ThreadPool {
  ...
  private static Logger logger = PceeLoggerFactory.getLogger(ThreadPool.class);
