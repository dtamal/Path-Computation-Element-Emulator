...
public class PCEPAddress extends EROSubobjects {
  ...
  public void setIPv4AddressBinaryString(String binaryString, boolean binaryRepresentation) {
    ...
    if (binaryRepresentation) {
      String checkedBinaryString =
          PCEPComputationFactory.setBinaryString(binaryString, IPv4AddressLength);
      ...
      String checkedBinaryString =
          PCEPComputationFactory.setBinaryString(address, IPv4AddressLength); // TODO CHECK
      this.IPv4Address = checkedBinaryString;
    }
  }
  ...
  public void setPrefixLengthBinaryString(String binaryString) {
    //	String checkedBinaryString = PCEPComputationFactory.setBinaryString(binaryString,
    // prefixLengthLength);
  ...
  private String convertAddressToBinaryAddress(String input) {
    ...
    while (addressTokenizer.hasMoreTokens()) {
      ...
      String completeBinaryString =
          PCEPComputationFactory.appendZerosToBinaryString(nonRevertedbinaryString, tokenLength);
