...
public interface PceObjectFrame {

  String NAME = new String();

  PceCommonObjectHeader getObjectHeader();

  void setObjectHeader(PceCommonObjectHeader objectHeader);

  String getObjectBinaryString();

  void setObjectBinaryString(String objectString);

  int getObjectFrameByteLength();

  String getObjectFrameBinaryString();

  String binaryInformation();
