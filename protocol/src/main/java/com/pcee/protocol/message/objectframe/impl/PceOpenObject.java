 ...
 * </pre>
 */
public class PceOpenObject implements PceObjectFrame {
  ...
  private int versionStartBit = PceConstantValues.OPEN_OBJECT_VERSION_START_BIT;
  private int versionEndBit = PceConstantValues.OPEN_OBJECT_VERSION_END_BIT;
  private int versionLength = PceConstantValues.OPEN_OBJECT_VERSION_LENGTH;

  private int keepAliveStartBit = PceConstantValues.OPEN_OBJECT_KEEPALIVE_START_BIT;
  private int keepAliveEndBit = PceConstantValues.OPEN_OBJECT_KEEPALIVE_END_BIT;
  private int keepAliveLength = PceConstantValues.OPEN_OBJECT_KEEPALIVE_LENGTH;

  private int deadTimerStartBit = PceConstantValues.OPEN_OBJECT_DEADTIMER_START_BIT;
  private int deadTimerEndBit = PceConstantValues.OPEN_OBJECT_DEADTIMER_END_BIT;
  private int deadTimerLength = PceConstantValues.OPEN_OBJECT_DEADTIMER_LENGTH;

  private int sessionIDStartBit = PceConstantValues.OPEN_OBJECT_SESSIONID_START_BIT;
  private int sessionIDEndBit = PceConstantValues.OPEN_OBJECT_SESSIONID_END_BIT;
  private int sessionIDLength = PceConstantValues.OPEN_OBJECT_SESSIONID_LENGTH;

  private int flagsStartBit = PceConstantValues.OPEN_OBJECT_FLAGS_START_BIT;
  private int flagsEndBit = PceConstantValues.OPEN_OBJECT_FLAGS_END_BIT;
  private int flagsLength = PceConstantValues.OPEN_OBJECT_FLAGS_LENGTH;

  public PceOpenObject(PceCommonObjectHeader objectHeader, String binaryString) {
    this.setObjectHeader(objectHeader);
    this.setObjectBinaryString(binaryString);
    this.updateHeaderLength();
  }

  public PceOpenObject(
  ...
  public int getVersionDecimalValue() {
    int decimalValue = (int) PceComputationFactory.getDecimalValue(version);
    return decimalValue;
  }
  ...
  public void setVersionBinaryString(String binaryString) {
    String checkedBinaryString = PceComputationFactory.setBinaryString(binaryString, versionLength);
  ...
  public int getKeepAliveDecimalValue() {
    int decimalValue = (int) PceComputationFactory.getDecimalValue(keepAlive);
    return decimalValue;
  }
  ...
  public void setKeepAliveDecimalValue(int decimalValue) {
    ...
    this.keepAlive = PceComputationFactory.setDecimalValue(decimalValue, maxValue, binaryLength);
  }

  public void setKeepAliveBinaryString(String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(binaryString, keepAliveLength);
  ...
  public void setKeepAliveBinaryString(int startingBit, String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(
            keepAlive, startingBit, binaryString, keepAliveLength);
    this.keepAlive = checkedBinaryString;
  }

  /** deadTimer */
  public int getDeadTimerDecimalValue() {
    int decimalValue = (int) PceComputationFactory.getDecimalValue(deadTimer);
    return decimalValue;
  }
  ...
  public void setDeadTimerDecimalValue(int decimalValue) {
    ...
    this.deadTimer = PceComputationFactory.setDecimalValue(decimalValue, maxValue, binaryLength);
  }

  public void setDeadTimerBinaryString(String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(binaryString, deadTimerLength);
  ...
  public void setDeadTimerBinaryString(int startingBit, String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(
            deadTimer, startingBit, binaryString, deadTimerLength);
    this.deadTimer = checkedBinaryString;
  }

  /** sessionID */
  public int getSessionIDDecimalValue() {
    int decimalValue = (int) PceComputationFactory.getDecimalValue(sessionID);
    return decimalValue;
  }
  ...
  public void setSessionIDDecimalValue(int decimalValue) {
    ...
    this.sessionID = PceComputationFactory.setDecimalValue(decimalValue, maxValue, binaryLength);
  }

  public void setSessionIDBinaryString(String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(binaryString, sessionIDLength);
  ...
  public void setSessionIDBinaryString(int startingBit, String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(
            sessionID, startingBit, binaryString, sessionIDLength);
    this.sessionID = checkedBinaryString;
  }
  ...
  public String toString() {
    ...
    String objectInfo =
        NAME + ":" + versionInfo + flagsInfo + keepAliveInfo + deadTimerInfo + sessionIDInfo + ">";
