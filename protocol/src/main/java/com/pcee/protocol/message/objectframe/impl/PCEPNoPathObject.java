...
public class PCEPNoPathObject implements PCEPObjectFrame {
	...
	private int constraintsFlagStartBit = PCEPConstantValues.NO_PATH_OBJECT_FLAG_FLAG_CONSTRAINTS_START_BIT;
	private int constraintsFlagEndBit = PCEPConstantValues.NO_PATH_OBJECT_FLAG_FLAG_CONSTRAINTS_END_BIT;
	private int constraintsFlagLength = PCEPConstantValues.NO_PATH_OBJECT_FLAG_FLAG_CONSTRAINTS_LENGTH;
	...
	public PCEPNoPathObject(PCEPCommonObjectHeader objectHeader, int natureOfIssue, String constraintsFlag) {
		this.setObjectHeader(objectHeader);
