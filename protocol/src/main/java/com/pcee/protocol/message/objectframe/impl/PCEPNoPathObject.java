 ...
 * </pre>
 */
public class PCEPNoPathObject implements PCEPObjectFrame {
  ...
  private int natureOfIssueStartBit = PCEPConstantValues.NO_PATH_OBJECT_NATURE_OF_ISSUE_START_BIT;
  private int natureOfIssueEndBit = PCEPConstantValues.NO_PATH_OBJECT_NATURE_OF_ISSUE_END_BIT;
  private int natureOfIssueLength = PCEPConstantValues.NO_PATH_OBJECT_NATURE_OF_ISSUE_LENGTH;

  private int flagsStartBit = PCEPConstantValues.NO_PATH_OBJECT_FLAGS_START_BIT;
  private int flagsEndBit = PCEPConstantValues.NO_PATH_OBJECT_FLAGS_END_BIT;
  private int flagsLength = PCEPConstantValues.NO_PATH_OBJECT_FLAGS_LENGTH;

  private int constraintsFlagStartBit =
      PCEPConstantValues.NO_PATH_OBJECT_FLAG_FLAG_CONSTRAINTS_START_BIT;
  private int constraintsFlagEndBit =
      PCEPConstantValues.NO_PATH_OBJECT_FLAG_FLAG_CONSTRAINTS_END_BIT;
  private int constraintsFlagLength =
      PCEPConstantValues.NO_PATH_OBJECT_FLAG_FLAG_CONSTRAINTS_LENGTH;

  private int reservedStartBit = PCEPConstantValues.NO_PATH_OBJECT_RESERVED_START_BIT;
  private int reservedEndBit = PCEPConstantValues.NO_PATH_OBJECT_RESERVED_END_BIT;
  private int reservedLength = PCEPConstantValues.NO_PATH_OBJECT_RESERVED_LENGTH;

  public PCEPNoPathObject(PCEPCommonObjectHeader objectHeader, String binaryString) {
    this.setObjectHeader(objectHeader);
    this.setObjectBinaryString(binaryString);
    this.updateHeaderLength();
  }

  public PCEPNoPathObject(
      PCEPCommonObjectHeader objectHeader, int natureOfIssue, String constraintsFlag) {
    this.setObjectHeader(objectHeader);
  ...
  public void setReservedBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, reservedLength);
    this.reserved = checkedBinaryString;
  }

  public void setReservedBinaryString(int startingBit, String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(reserved, startingBit, binaryString, reservedLength);
    this.reserved = checkedBinaryString;
  }
  ...
  public void setFlagsBinaryString(int startingBit, String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(flags, startingBit, binaryString, flagsLength);
    this.flags = checkedBinaryString;
  }
