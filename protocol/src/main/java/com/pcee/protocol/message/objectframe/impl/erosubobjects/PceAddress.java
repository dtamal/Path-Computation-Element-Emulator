...
public class PceAddress extends EroSubobjects {
  /**
   * <pre>
   *  0                   1                   2                   3
  ...
  // Only used in PceEndPointsObject for 32 bit input
  public PceAddress(String binaryString) {
    NAME = "PceAddress";
  ...
  public PceAddress(String address, boolean binaryRepresentation) {
    NAME = "PceAddress";
  ...
  public PceAddress(String address, int port) {
    NAME = "PceAddress";
    this.setLFlagDecimalValue(0);
    this.setTypeDecimalValue(EroSubobjects.PCEPIPv4AddressType);
    this.setLengthDecimalValue(8);
  ...
  public void deserialize(String binaryString) {
    ...
    String IPv4AddressBinaryString =
        binaryString.substring(IPv4AddressStartBit, IPv4AddressEndBit + 1);
    String prefixLengthBinaryString =
        binaryString.substring(prefixLengthStartBit, prefixLengthEndBit + 1);
  ...
  public void setIPv4AddressBinaryString(String binaryString, boolean binaryRepresentation) {
    ...
    if (binaryRepresentation) {
      String checkedBinaryString =
          PceComputationFactory.setBinaryString(binaryString, IPv4AddressLength);
      ...
      String checkedBinaryString =
          PceComputationFactory.setBinaryString(address, IPv4AddressLength); // TODO CHECK
      this.IPv4Address = checkedBinaryString;
    }
  }
  ...
  public int getPrefixLengthDecimalValue() {
    int decimalValue = (int) PceComputationFactory.getDecimalValue(prefixLength);
    return decimalValue;
  }
  ...
  public void setPrefixLengthDecimalValue(int decimalValue) {
    ...
    this.prefixLength = PceComputationFactory.setDecimalValue(decimalValue, maxValue, binaryLength);
  }
   ...
   *
   * @param x .x.x.x schema will be transformed in binaryAddress
   */
  private String convertAddressToBinaryAddress(String input) {
    ...
    while (addressTokenizer.hasMoreTokens()) {
      ...
      String nonRevertedbinaryString =
          Integer.toBinaryString(Integer.valueOf(currentAddressToken).intValue());
      String completeBinaryString =
          PceComputationFactory.appendZerosToBinaryString(nonRevertedbinaryString, tokenLength);
