...
public class PCEPObjectFrameFactory {
  ...
  private static final Logger logger = LoggerFactory.getLogger(PCEPObjectFrameFactory.class);

  public static PCEPOpenObject generatePCEPOpenObject(
  ...
  public static PCEPRequestParametersObject generatePCEPRequestParametersObject(
    ...
    PCEPRequestParametersObject object =
        new PCEPRequestParametersObject(
  ...
  public static PCEPRequestParametersObject generatePCEPRequestParametersObject(
    ...
    PCEPCommonObjectHeader objectHeader = new PCEPCommonObjectHeader(2, 1, pFlag, iFlag);
    PCEPRequestParametersObject object =
        new PCEPRequestParametersObject(objectHeader, oFlag, bFlag, rFlag, priFlag, requestID);

    return object;
  }

  public static PCEPNoPathObject generatePCEPNoPathObject(
  ...
  public static PCEPEndPointsObject generatePCEPEndPointsObject(
      String pFlag, String iFlag, PCEPAddress sourceAddress, PCEPAddress destinationAddress) {
    // TODO IPv6
    PCEPCommonObjectHeader objectHeader = new PCEPCommonObjectHeader(4, 1, pFlag, iFlag);
    PCEPEndPointsObject object =
        new PCEPEndPointsObject(objectHeader, sourceAddress, destinationAddress);

    return object;
  }

  public static PCEPBandwidthObject generatePCEPBandwidthObject(
  ...
  public static PCEPMetricObject generatePCEPMetricObject(
  ...
  public static PCEPExplicitRouteObject generatePCEPExplicitRouteObject(
    ...
    PCEPExplicitRouteObject object =
        new PCEPGenericExplicitRouteObjectImpl(objectHeader, subObjects);
  ...
  public static PCEPReportedRouteObject generatePCEPReportedRouteObject(
    ...
    PCEPReportedRouteObject object =
        new PCEPReportedRouteObject(objectHeader, type, length, routerID, interfaceID);
  ...
  public static PCEPLabelSwitchedPathAttributesObject generatePCEPLabelSwitchedPathAttributesObject(
    ...
    PCEPLabelSwitchedPathAttributesObject object =
        new PCEPLabelSwitchedPathAttributesObject(
  ...
  public static PCEPSynchronizationVectorObject generatePCEPSynchronizationVectorObject(
    ...
    PCEPSynchronizationVectorObject object =
        new PCEPSynchronizationVectorObject(objectHeader, sFlag, nFlag, lFlag, requestIDNumbers);

    return object;
  }

  public static PCEPErrorObject generatePCEPErrorObject(
  ...
  public static PCEPLoadBalancingObject generatePCEPLoadBalancingObject(
    ...
    PCEPLoadBalancingObject object =
        new PCEPLoadBalancingObject(objectHeader, maxLSP, minBandwidth);
  ...
  public static PCEPObjectiveFunctionObject generatePCEPObjectiveFunctionObject(
      String pFlag, String iFlag, int ofCode) {
    PCEPCommonObjectHeader objectHeader = new PCEPCommonObjectHeader(21, 1, pFlag, iFlag);
  ...
  public static PCEPObjectFrame getPCEPObjectFrame(String objectString) {
    String objectHeaderString =
        objectString.substring(0, PCEPConstantValues.COMMON_OBJECT_HEADER_LENGTH);
  ...
  public static LinkedList<String> splitObjectsRawString(String objectsRawString) {
    ...
    while (objectsRawString.length() > 0) {
      String objectHeaderString =
          objectsRawString.substring(0, PCEPConstantValues.COMMON_OBJECT_HEADER_LENGTH);
      PCEPCommonObjectHeader objectHeader = new PCEPCommonObjectHeader(objectHeaderString);
