...
public class PCEPLabelSwitchedPathAttributesObject implements PCEPObjectFrame {
  ...
  public PCEPLabelSwitchedPathAttributesObject(
      PCEPCommonObjectHeader objectHeader, String binaryString) {
  ...
  public void setExcludeAnyBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, excludeAnyLength);
  ...
  public void setIncludeAnyBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, includeAnyLength);
  ...
  public void setIncludeAllBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, includeAllLength);
  ...
  public void setSetupPrioBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, setupPrioLength);
  ...
  public void setHoldingPrioBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, holdingPrioLength);
