...
public class PCEPMessageFactory {
  ...
  public static PCEPMessage generateSIMPLEErrorMessage(
    ...
    PCEPErrorObject errorObject =
        PCEPObjectFrameFactory.generatePCEPErrorObject(pFlag, iFlag, type, value);
  ...
  public static PCEPMessage generateMessage(PCEPMessageFrame messageFrame) {
    PCEPCommonMessageHeader messageHeader =
        new PCEPCommonMessageHeader(1, messageFrame.getMessageType());
