 ...
 * </pre>
 */
public class PceEndPointsObject implements PceObjectFrame {
  ...
  private int sourceAddressStartBit = PceConstantValues.END_POINTS_OBJECT_SOURCE_ADDRESS_START_BIT;
  private int sourceAddressEndBit = PceConstantValues.END_POINTS_OBJECT_SOURCE_ADDRESS_END_BIT;
  private int sourceAddressLength = PceConstantValues.END_POINTS_OBJECT_SOURCE_ADDRESS_LENGTH;

  private int destinationAddressStartBit =
      PceConstantValues.END_POINTS_OBJECT_DESTINATION_ADDRESS_START_BIT;
  private int destinationAddressEndBit =
      PceConstantValues.END_POINTS_OBJECT_DESTINATION_ADDRESS_END_BIT;
  private int destinationAddressLength =
      PceConstantValues.END_POINTS_OBJECT_DESTINATION_ADDRESS_LENGTH;

  public PceEndPointsObject(PceCommonObjectHeader objectHeader, String binaryString) {
    this.setObjectHeader(objectHeader);
    this.setObjectBinaryString(binaryString);
    this.updateHeaderLength();
  }

  public PceEndPointsObject(
      PceCommonObjectHeader objectHeader, PceAddress sourceAddress, PceAddress destinationAddress) {
    this.setObjectHeader(objectHeader);
  ...
  public void setObjectBinaryString(String binaryString) {
    String sourceAddressBinaryString =
        binaryString.substring(sourceAddressStartBit, sourceAddressEndBit + 1);
    String destinationAddressBinaryString =
        binaryString.substring(destinationAddressStartBit, destinationAddressEndBit + 1);
  ...
  public void setSourceAddressBinaryString(String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(binaryString, sourceAddressLength);
   ...
   * PceComputationFactory.setBinaryString(sourceAddress, startingBit,
  ...
  public void setDestinationAddressBinaryString(String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(binaryString, destinationAddressLength);
  ...
  public void setDestinationAddressBinaryString(int startingBit, String binaryString) {
    String checkedBinaryString =
        PceComputationFactory.setBinaryString(
            destinationAddress, startingBit, binaryString, destinationAddressLength);
    this.destinationAddress = checkedBinaryString;
  }

  public String toString() {

    PceAddress sourceAddress = new PceAddress(this.getSourceAddressBinaryString());
    PceAddress destinationAddress = new PceAddress(this.getDestinationAddressBinaryString());

    String sourceAddressInfo = "SourceAddress=" + sourceAddress.getIPv4Address(false);
    String destinationAddressInfo =
        ",DestinationAddress=" + destinationAddress.getIPv4Address(false);
