...
public class PCEPEndPointsObject implements PCEPObjectFrame {
  ...
  private int destinationAddressStartBit =
      PCEPConstantValues.END_POINTS_OBJECT_DESTINATION_ADDRESS_START_BIT;
  private int destinationAddressEndBit =
      PCEPConstantValues.END_POINTS_OBJECT_DESTINATION_ADDRESS_END_BIT;
  private int destinationAddressLength =
      PCEPConstantValues.END_POINTS_OBJECT_DESTINATION_ADDRESS_LENGTH;
  ...
  public PCEPEndPointsObject(
      PCEPCommonObjectHeader objectHeader,
      PCEPAddress sourceAddress,
  ...
  public void setSourceAddressBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, sourceAddressLength);
  ...
  public void setDestinationAddressBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, destinationAddressLength);
