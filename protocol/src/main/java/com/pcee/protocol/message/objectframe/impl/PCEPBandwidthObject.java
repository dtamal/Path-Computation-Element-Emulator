...
public class PCEPBandwidthObject implements PCEPObjectFrame {
  ...
  public PCEPBandwidthObject(
      PCEPCommonObjectHeader objectHeader, String bandwidthBinaryRepresentation) {
  ...
  public void setBandwidthBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, bandwidthLength);
