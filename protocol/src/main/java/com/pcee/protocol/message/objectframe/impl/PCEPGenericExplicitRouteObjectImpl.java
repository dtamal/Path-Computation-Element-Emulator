...
public class PCEPGenericExplicitRouteObjectImpl extends PCEPExplicitRouteObject {
  ...
  public PCEPGenericExplicitRouteObjectImpl(
  ...
  public PCEPGenericExplicitRouteObjectImpl(
      PCEPCommonObjectHeader objectHeader, ArrayList<EROSubobjects> traversedVertexList) {
    this.setObjectHeader(objectHeader);
    ...
    for (EROSubobjects address : traversedVertexList) {
      if (address instanceof PCEPAddress)
        traversedVertexesList =
            traversedVertexesList + ((PCEPAddress) address).getIPv4Address(false) + "-";
  ...
  public static void main(String[] args) {
    ...
    PCEPGenericExplicitRouteObjectImpl a =
        new PCEPGenericExplicitRouteObjectImpl(objectHeader, temp);
    ...
    PCEPGenericExplicitRouteObjectImpl b =
        new PCEPGenericExplicitRouteObjectImpl(
