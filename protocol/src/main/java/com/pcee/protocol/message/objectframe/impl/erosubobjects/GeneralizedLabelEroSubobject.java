...
public class GeneralizedLabelEroSubobject extends LabelEroSubobject {
  ...
  */
  ...
  public int getGridDecimalValue() {
    int gridValue = (int) PceComputationFactory.getDecimalValue(grid);
    return gridValue;
  }
  ...
  public int getChannelSpacingDecimalValue() {
    int channelSpacingValue = (int) PceComputationFactory.getDecimalValue(channelSpacing);
  ...
  public int getIdentifierDecimalValue() {
    int identifierValue = (int) PceComputationFactory.getDecimalValue(identifier);
  ...
  public int getNDecimalValue() {
    int nValue = (int) PceComputationFactory.getDecimalValue(n);
    return nValue;
  }
  ...
  public String getObjectBinaryString() {
    String binaryString =
        getLabelObjectHeaderBinaryString() + grid + channelSpacing + identifier + n;
    return binaryString;
  }
  ...
  public void setObjectBinaryString(String binaryString) {
    ...
    String channelSpacingBinaryString =
        binaryString.substring(channelSpacingStartBit, channelSpacingEndBit + 1);
    String identifierBinaryString =
        binaryString.substring(identifierStartBit, identifierEndBit + 1);
  ...
  public int getByteLength() {
    return getLabelObjectHeaderByteLength()
        + (grid.length() + channelSpacing.length() + identifier.length() + n.length()) / 8;
  }
  ...
  public String toString() {
    ...
    String objectInfo =
        NAME + ":" + headerString() + gridInfo + channelSpacingInfo + identifierInfo + nInfo + ">";
  ...
  public String binaryInformation() {
    ...
    String objectInfo =
        "[" + gridBinaryInfo + channelSpacingBinaryInfo + identifierBinaryInfo + nInfo + "]";
