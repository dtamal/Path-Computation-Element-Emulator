...
public class PCEPLoadBalancingObject implements PCEPObjectFrame {
  ...
  private int minBandwidthStartBit =
      PCEPConstantValues.LOAD_BALANCING_OBJECT_MIN_BANDWIDTH_START_BIT;
  ...
  public PCEPLoadBalancingObject(
      PCEPCommonObjectHeader objectHeader, int maxLSP, String minBandwidth) {
    this.setObjectHeader(objectHeader);
  ...
  public void setMaxLSPBinaryString(int startingBit, String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(maxLSP, startingBit, binaryString, maxLSPLength);
    this.maxLSP = checkedBinaryString;
  }
  ...
  public void setMinBandwidthBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, minBandwidthLength);
