...
public class PCEPRequestParametersObject implements PCEPObjectFrame {
  ...
  private int requestIDNumberStartBit =
      PCEPConstantValues.REQUEST_PARAMETERS_OBJECT_REQUEST_ID_NUMBER_START_BIT;
  private int requestIDNumberEndBit =
      PCEPConstantValues.REQUEST_PARAMETERS_OBJECT_REQUEST_ID_NUMBER_END_BIT;
  private int requestIDNumberLength =
      PCEPConstantValues.REQUEST_PARAMETERS_OBJECT_REQUEST_ID_NUMBER_LENGTH;
  ...
  public PCEPRequestParametersObject(
  ...
  public void setRequestIDNumberBinaryString(String binaryString) {
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(binaryString, requestIDNumberLength);
  ...
  public void setBFlagBinaryString(String binaryString) {
    int relativeStartBit = (bFlagStartBit - flagsStartBit);
    String checkedBinaryString =
        PCEPComputationFactory.setBinaryString(flags, relativeStartBit, binaryString, flagsLength);
    this.flags = checkedBinaryString;
  }
