...
public class PceNotificationFrame implements PceMessageFrame {

  public final int MESSAGE_TYPE = 5;

  LinkedList<PceNotificationObject> notificationList;
  LinkedList<PceRequestParametersObject> rpList;

  public PceNotificationFrame(LinkedList<PceNotificationObject> notificationList) {
    this.notificationList = notificationList;
  }

  public void insertRequestParametersObjectList(LinkedList<PceRequestParametersObject> rpList) {
    this.rpList = rpList;
  }
