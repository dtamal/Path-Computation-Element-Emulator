...
import com.graph.topology.importers.impl.XMLImportTopology;
...
public class TopologyInformation {
    ...
    /**
     * @param importer
     *            ONLY SNDLib, BRITE and XML supported as input. If the input is incorrect or not supported, SNDLib will be used
     */
	...
	} else if (importer.equals("XML")) {
	    topology = new XMLImportTopology();
	} else {
	    topology = new SNDLibImportTopology();
	}
    }
