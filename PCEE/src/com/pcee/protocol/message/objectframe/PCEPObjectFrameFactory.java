...
public class PCEPObjectFrameFactory {
	...
	public static PCEPEndPointsObject generatePCEPEndPointsObject(String pFlag, String iFlag, Address sourceAddress, Address destinationAddress) {
		// TODO IPv6
	...
	public static PCEPBandwidthObject generatePCEPBandwidthObject(String pFlag, String iFlag, String bandwidth) {
	...
	public static PCEPMetricObject generatePCEPMetricObject(String pFlag, String iFlag, String cFlag, String bFlag, int type, String metricValue) {
	...
	public static PCEPExplicitRouteObject generatePCEPExplicitRouteObject(String pFlag, String iFlag, ArrayList<Address> subObjects) {
		PCEPCommonObjectHeader objectHeader = new PCEPCommonObjectHeader(7, 1, pFlag, iFlag);
		PCEPExplicitRouteObject object = new PCEPExplicitRouteObject(objectHeader, subObjects);
	...
	public static PCEPNotificationObject generatePCEPNotificationObject(String pFlag, String iFlag, int notificationType, int notificationValue) {
		PCEPCommonObjectHeader objectHeader = new PCEPCommonObjectHeader(12, 1, pFlag, iFlag);
		PCEPNotificationObject object = new PCEPNotificationObject(objectHeader, notificationType, notificationValue);
	...
	public static PCEPObjectFrame getPCEPObjectFrame(String objectString) {
		...
		case 7:
			return new PCEPExplicitRouteObject(objectHeader, objectString);
		case 8:
		...
		case 12:
			return new PCEPNotificationObject(objectHeader, objectString);
		case 13:
