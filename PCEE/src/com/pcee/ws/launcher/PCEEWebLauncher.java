...
public class PCEEWebLauncher {
	...
	private static Logger logger = LoggerFactory
			.getLogger(PCEEWebLauncher.class);
	...
	public static void setServerModuleManagement(
	...
	/**
	 * Function to parse the input parameters to identify if the instance should
	 * be a PCEE server or client instance
	 * 
	 * @param args
	...
	/**
	 * Function to generate the Jersey handler based on the configuration
	 * defined using the web.xml file
	 * 
	 * @param isServerRole
	 *            boolean to indicate if the configuration should be
	 *            instantiated for a PCEE server or a client
	 * @return
	 * @throws IOException
	 * @throws MalformedURLException
	 */
	private static ServletContextHandler getJerseyContext(boolean isServerRole)
	 ...
	 * @return
	 */
	private static ContextHandler getStaticContext(boolean isServerRole)
			throws MalformedURLException, IOException {
		// Code to add Jersey Servlet to the Jetty Handlers
		...
		if (isServerRole)
			resource_handler.setBaseResource(Resource
					.newResource("PCEEServer_WEB"));
		else
			resource_handler.setBaseResource(Resource
					.newResource("PCEEClient_WEB"));
	...
	/**
	 * Function to generate jetty Handlers based on how an instance is started
	 * in the code
	 * 
	 ...
	 * @throws IOException
	 */
	private static HandlerList getWsHandlers(boolean isServerRole)
			throws MalformedURLException, IOException {
		...
		handlers.setHandlers(new Handler[] { jerseyContext,
				staticContentContext, new DefaultHandler() });
