 ...
 * 
 */
public class ITMultiPathResvElement extends ResvElement {
	 ...
	 * @param bw
	 */
	public ITMultiPathResvElement(String nextID, Gcontroller controller, String source, String destination, double startTime, double endTime, double bw) {
		graph = controller;
		this.ID = nextID;
		this.bw = bw;
	 ...
	 * @param bw
	 */
	public ITMultiPathResvElement(String nextID, Gcontroller controller, String source, String destination, int cpu, int ram, int storage, double startTime, double endTime, double bw) {
		graph = controller;
		this.ID = nextID;
		this.bw = bw;
		this.startTime = startTime;
